...
The validator checks JavaScript parsing, DOM IDs and references, packed-model byte ranges and indices, external source integrity, vehicle/model mappings, district counts, Great Bridge geometry, and the physical collider regression guards.
